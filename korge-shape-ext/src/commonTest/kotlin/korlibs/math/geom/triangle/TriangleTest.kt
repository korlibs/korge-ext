...
class TriangleTest {
    ...
    fun test() {
        ...
        assertEquals(Point(0, 0), t1.point(0).point)
        assertEquals(Point(10, 0), t1.point(1).point)
        assertEquals(Point(0, 10), t1.point(2).point)

        assertEquals(Point(0, 0), t1.p0.point)
        assertEquals(Point(10, 0), t1.p1.point)
        assertEquals(Point(0, 10), t1.p2.point)
